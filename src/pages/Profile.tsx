        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1, duration: 0.4 } as any}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update your name, phone number, and profile photo</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex gap-1 mt-1">
                      {roles.map((role) => (
                        <span key={role} className="text-xs font-medium px-2 py-0.5 rounded-full bg-accent text-accent-foreground capitalize">
                          {role}
                        </span>
                      ))}
                    </div>
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-2">
                    <Shield className="h-3.5 w-3.5 text-muted-foreground" /> Roles
                  </Label>
                  <div className="flex gap-2">
                    {roles.map((role) => (
                      <span key={role} className="text-sm font-medium px-3 py-1 rounded-lg bg-accent text-accent-foreground capitalize">
                        {role}
                      </span>
                    ))}
                  </div>
                ...
                <Button
                  type="submit"
                  className="w-full sm:w-auto rounded-xl shadow-soft"
