...
export default function AppointmentProcessPage() {
  ...
  const steps = [
    {
      number: "01",
      title: t.appointmentProcessStep1Title,
      description: t.appointmentProcessStep1Desc,
    },
    {
      number: "02",
      title: t.appointmentProcessStep2Title,
      description: t.appointmentProcessStep2Desc,
    },
    {
      number: "03",
      title: t.appointmentProcessStep3Title,
      description: t.appointmentProcessStep3Desc,
    },
  ];
