...
ALTER TABLE "doctor_availability_overrides" DROP CONSTRAINT "doctor_availability_overrides_doctor_date_type_unique";--> statement-breakpoint
ALTER TABLE "clinics" ADD COLUMN "logo_url" varchar(500);--> statement-breakpoint
...
ALTER TABLE "trusted_devices" ADD CONSTRAINT "trusted_devices_clinic_id_clinics_id_fk" FOREIGN KEY ("clinic_id") REFERENCES "public"."clinics"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
